...
const ScholarshipsHeader = () => {
  return (
    <section>
      ...
      {/* Scholarship Info */}
      <main className="min-h-screen relative bottom-35 md:bottom-0 lg:bottom-0 py-8 px-4 sm:py-2 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl space-y-6">
          ...
          {/* Footer */}
          <footer className="rounded-2xl bg-white/95 p-6 text-center shadow-lg sm:p-8">
            ...
            <div className="flex flex-col items-center justify-center gap-4 text-gray-600 sm:flex-row sm:gap-8">
              <div className="flex items-center gap-2">
                ...
                <span>petrofund@namcor.com.na</span>
              </div>
              <div className="flex items-center gap-2">
                <svg
                  className="h-5 w-5 text-purple-700"
